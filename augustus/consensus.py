...
def consensus_by_biotype(cur, ref_genome, genome, biotype, gps, transcript_gene_map, gene_transcript_map, stats):
    """
...
def evaluate_coding_consensus(binned_transcripts, stats, gps):
    """
